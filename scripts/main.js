...
paddleImg.src = "images/cannon.png";
...
var bulletSound = new Audio("audio/bullet.wav");
...
var rockers = [];
class Rocks {
    constructor(x, y, dx, dy, radius, color, parent) {
        this.x = x;
        this.y = y;
        this.dx = dx;
        this.dy = dy;
...
function drawPaddle() {
    ...
    ctx.closePath(); 
*/
    ctx.drawImage(paddleImg, (paddleX - 35), paddleY);
}
...
document.addEventListener('keyup', keyUpHandler, false);        // bgScore.pause();
// mute = false;
